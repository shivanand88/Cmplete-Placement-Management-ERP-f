...
Public Class frmHobbiesRecord
    ...
    Private Sub frmHobbiesRecord_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmd = New OleDbCommand("SELECT Hostelers.HostelerID as [Hosteler ID],Hostelers.HostelerName as [Hosteler Name],Hostelers.USN as [USN],Hobbies.Hobby1 as [Hobby 1], Hobbies.Hobby2 as [Hobby 2], Hobbies.Hobby3 as [Hobby 3], Hobbies.Hobby4 as [Hobby 4], Hobbies.Hobby5 as [Hobby 5], Hobbies.Hobby6 as [Hobby 6], Hobbies.Hobby7 as [Hobby 7], Hobbies.Hobby8 as [Hobby 8] FROM Hostelers INNER JOIN Hobbies ON Hostelers.[HostelerID] = Hobbies.[HostelerID]  order by HostelerName ", con)
    ...
    Private Sub cmbHostelerName_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbHostelerName.SelectedIndexChanged
        Try
            ...
            con.Open()
            'cmd = New OleDbCommand("SELECT HostelerID as [Hosteler ID],HostelerName as [Hosteler Name], from Hostelers where HostelerName='" & cmbHostelerName.Text & "' order by HostelerName", con)
            cmd = New OleDbCommand("SELECT Hostelers.HostelerID as [Hosteler ID],Hostelers.HostelerName as [Hosteler Name],Hostelers.USN as [USN],Hobbies.Hobby1 as [Hobby 1], Hobbies.Hobby2 as [Hobby 2], Hobbies.Hobby3 as [Hobby 3], Hobbies.Hobby4 as [Hobby 4], Hobbies.Hobby5 as [Hobby 5], Hobbies.Hobby6 as [Hobby 6], Hobbies.Hobby7 as [Hobby 7], Hobbies.Hobby8 as [Hobby 8] FROM Hostelers INNER JOIN Hobbies ON Hostelers.[HostelerID] = Hobbies.[HostelerID] where HostelerName='" & cmbHostelerName.Text & "' and Hobbies.HostelerID=Hostelers.HostelerID order by HostelerName ", con)
            Dim myDA As OleDbDataAdapter = New OleDbDataAdapter(cmd)
            Dim myDataSet As DataSet = New DataSet()
            myDA.Fill(myDataSet, "Hostelers")
            myDA.Fill(myDataSet, "hobbies")
    ...
    Private Sub txtHostelerName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtHostelerName.TextAlignChanged
        Try
            con = New OleDbConnection(cs)
            con.Open()
            'cmd = New OleDbCommand("SELECT HostelerID as [Hosteler ID],HostelerName as [Hosteler Name], from Hostelers where HostelerName='" & cmbHostelerName.Text & "' order by HostelerName", con)
    ...
    Private Sub txtHobby_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtHobby.TextAlignChanged
        Try
            con = New OleDbConnection(cs)
            con.Open()
            'cmd = New OleDbCommand("SELECT HostelerID as [Hosteler ID],HostelerName as [Hosteler Name], from Hostelers where HostelerName='" & cmbHostelerName.Text & "' order by HostelerName", con)
            cmd = New OleDbCommand("SELECT Hostelers.HostelerID as [Hosteler ID],Hostelers.HostelerName as [Hosteler Name],Hostelers.USN as [USN],Hobbies.Hobby1 as [Hobby 1], Hobbies.Hobby2 as [Hobby 2], Hobbies.Hobby3 as [Hobby 3], Hobbies.Hobby4 as [Hobby 4], Hobbies.Hobby5 as [Hobby 5], Hobbies.Hobby6 as [Hobby 6], Hobbies.Hobby7 as [Hobby 7], Hobbies.Hobby8 as [Hobby 8] FROM Hostelers INNER JOIN Hobbies ON Hostelers.[HostelerID] = Hobbies.[HostelerID] where Hobbies.hobby1 like '" & txtHobby.Text & "%' or Hobbies.hobby2 like '" & txtHobby.Text & "%' or Hobbies.hobby3 like '" & txtHobby.Text & "%'  or  Hobbies.hobby4 like '" & txtHobby.Text & "%' or Hobbies.hobby5 like '" & txtHobby.Text & "%' or Hobbies.hobby6 like '" & txtHobby.Text & "%'  and Hobbies.HostelerID=Hostelers.HostelerID order by HostelerName ", con)
            Dim myDA As OleDbDataAdapter = New OleDbDataAdapter(cmd)
            Dim myDataSet As DataSet = New DataSet()
            myDA.Fill(myDataSet, "Hostelers")
            myDA.Fill(myDataSet, "Hobbies")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            con.Open()
            'cmd = New OleDbCommand("SELECT HostelerID as [Hosteler ID],HostelerName as [Hosteler Name], from Hostelers where HostelerName='" & cmbHostelerName.Text & "' order by HostelerName", con)
            cmd = New OleDbCommand("SELECT Hostelers.HostelerID as [Hosteler ID],Hostelers.HostelerName as [Hosteler Name],Hobbies.Hobby1 as [Hobby 1], Hobbies.Hobby2 as [Hobby 2], Hobbies.Hobby3 as [Hobby 3], Hobbies.Hobby4 as [Hobby 4], Hobbies.Hobby5 as [Hobby 5], Hobbies.Hobby6 as [Hobby 6], Hobbies.Hobby7 as [Hobby 7], Hobbies.Hobby8 as [Hobby 8] FROM Hostelers INNER JOIN Hobbies ON Hostelers.[HostelerID] = Hobbies.[HostelerID] where  Hobbies.HostelerID=Hostelers.HostelerID order by HostelerName ", con)
            Dim myDA As OleDbDataAdapter = New OleDbDataAdapter(cmd)
            Dim myDataSet As DataSet = New DataSet()
            myDA.Fill(myDataSet, "Hostelers")
            myDA.Fill(myDataSet, "Hobbies")
