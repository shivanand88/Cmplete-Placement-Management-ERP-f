...
Public Class frmRegRecord
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            frmRegCharges.txtPrevDue.Text = dr.Cells(9).Value.ToString()
            frmRegCharges.txtTotalCharges.Text = dr.Cells(10).Value.ToString()
            frmRegCharges.dtpPaymentDate.Text = dr.Cells(11).Value.ToString()
