...
Public Class frmAccountsRecord
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            'cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler name],Hostelers.USN as [USN],Hostelers.Purpose as [Department], Hostelers.HostelName as [Hostel Name], FeePayment.AcadYear as [Academic year], FeePayment.TotalPaid as [Total Paid],FeePayment.BankChallanNumber as [Bank Challan No], FeePayment.PaymentDate as [Payment Date] FROM Hostelers INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID]  where HostelName='" & cmbHostelName1.Text & "' and AcadYear = '" & cmbAcadYear.Text & "' order by HostelerName,AcadYear,paymentdate", con)
            'cmd = New OleDbCommand("SELECT distinct Hostelers.HostelerName as [Hosteler Name], Hostelers.USN as [USN], Hostelers.Purpose as [Department], RoomAllotment.Hostelname as [Hostel Name], RoomAllotment.RoomNo as [Room No] , RoomAllotment.AcadYear as [Acadeic Year], (FeePayment.ServiceCharges-RegCharges.PrevDue) as [ServiceCharges], RegCharges.PrevDue as[Prev Due],  FeePayment.ServiceCharges as [service Charge+Due], sum(FeePayment.Totalpaid) as [Total paid] FROM ((Hostelers INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]) INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where  RoomAllotment.HostelName BETWEEN RoomAllotment.HostelName='" & cmbHostelName1.Text & "' and RoomAllotment.HostelName='" & cmbHostelName3.Text & "' and RoomAllotment.AcadYear = '" & cmbAcadYear.Text & "' and FeePayment.AcadYear=RoomAllotment.AcadYear and FeePayment.AcadYear=RegCharges.AcadYear and RoomAllotment.AcadYear=RegCharges.AcadYear group by HostelerName,USn,purpose, RoomAllotment.Hostelname,RoomAllotment.RoomNo,ServiceCharges,RoomAllotment.AcadYear,RegCharges.PrevDue  order by Hostelername ", con)
            cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler Name] , Hostelers.USN as [USN] , RoomAllotment.Hostelname, Hostel.HostelType as [Hostel Name] , RoomAllotment.RoomNo  as [Room No] , RoomAllotment.AcadYear as [Acadeic Year] ,  (FeePayment.ServiceCharges- RegCharges.PrevDue) as [Service Charges] , RegCharges.PrevDue as[Prev Due] ,FeePayment.ServiceCharges as [service Charge+Due],  sum(FeePayment.Totalpaid) as [Total paid] FROM (Hostel INNER JOIN ((Hostelers INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]) INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) ON Hostel.[HostelName] = Hostelers.[HostelName]) INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where   Hostel.HostelType ='" & cmbHostelType2.Text & "' and RoomAllotment.AcadYear = '" & cmbAcadYear.Text & "'  and FeePayment.AcadYear=RoomAllotment.AcadYear and FeePayment.AcadYear=RegCharges.AcadYear and RoomAllotment.AcadYear=RegCharges.AcadYear group by HostelerName,USn,purpose, RoomAllotment.Hostelname,RoomAllotment.RoomNo,ServiceCharges,RoomAllotment.AcadYear,RegCharges.PrevDue,HostelType order by Hostelername ", con)
            ...
            For Each r As DataGridViewRow In Me.DataGridView3.Rows
                If (DataGridView3.Rows.Count <= 2) Then
                    If (r.Cells(7).Value > 0) Then
                        sum = sum + r.Cells(9).Value
                        sum1 = sum1 + ((r.Cells(6).Value + r.Cells(7).Value) - r.Cells(9).Value)
                    Else
                        sum = sum + r.Cells(9).Value
                        sum1 = sum1 + (r.Cells(6).Value - r.Cells(9).Value)
                    End If
                Else
                    sum = sum + r.Cells(9).Value
                    sum1 = sum1 + (r.Cells(6).Value - r.Cells(9).Value)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            'cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler name],Hostelers.USN as [USN],Hostelers.Purpose as [Department], Hostelers.HostelName as [Hostel Name], FeePayment.AcadYear as [Academic year], FeePayment.TotalPaid as [Total Paid],FeePayment.BankChallanNumber as [Bank Challan No], FeePayment.PaymentDate as [Payment Date] FROM Hostelers INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where Paymentdate between #" & DateFrom.Text & " # and #" & DateTo.Text & "# order by HostelName,PaymentDate", con)
            'cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler name],Hostelers.USN as [USN],Hostelers.Purpose as [Department], Hostelers.HostelName as [Hostel Name], FeePayment.AcadYear as [Academic year], sum(FeePayment.TotalPaid) as [Total Paid] FROM Hostelers INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where Paymentdate between #" & DateFrom.Text & " # and #" & DateTo.Text & "#  group by HostelerName,USN,Purpose,HostelName,AcadYear order by HostelName", con)
            'cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler name], Hostelers.USN as [USN], Hostelers.Purpose as [Department] , RoomAllotment.Hostelname as [Hostel Name], RoomAllotment.RoomNo as [Room NO],FeePayment.ServiceCharges as [Hostel Fee], sum(FeePayment.TotalPaid) as [Total paid],RoomAllotment.AcadYear as [Academic year] FROM (Hostelers INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where Paymentdate between #" & DateFrom.Text & " # and #" & DateTo.Text & "# and FeePayment.AcadYear=RoomAllotment.AcadYear group by HostelerName,USN,Purpose, RoomAllotment.Hostelname,RoomAllotment.RoomNo,ServiceCharges,RoomAllotment.AcadYear  order by Hostelername", con)
            ' cmd = New OleDbCommand("SELECT distinct Hostelers.HostelerName as [Hosteler Name], Hostelers.USN as [USN], Hostelers.Purpose as [Department], RoomAllotment.Hostelname as [Hostel Name], RoomAllotment.RoomNo as [Room No] , RoomAllotment.AcadYear as [Acadeic Year], (FeePayment.ServiceCharges-RegCharges.PrevDue) as [ServiceCharges], RegCharges.PrevDue as[Prev Due],  FeePayment.ServiceCharges as [service Charge+Due], sum(FeePayment.Totalpaid) as [Total paid] FROM ((Hostelers INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]) INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where FeePayment.Paymentdate between #" & DateFrom.Text & " # and #" & DateTo.Text & "# and FeePayment.AcadYear=RoomAllotment.AcadYear and FeePayment.AcadYear=RegCharges.AcadYear and RoomAllotment.AcadYear=RegCharges.AcadYear group by HostelerName,USn,purpose, RoomAllotment.Hostelname,RoomAllotment.RoomNo,ServiceCharges,RoomAllotment.AcadYear,RegCharges.PrevDue  order by Hostelername ", con)
            cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler Name] , Hostelers.USN as [USN] , RoomAllotment.Hostelname as [Hostel Name], Hostel.HostelType as [Hostel Type] , RoomAllotment.RoomNo  as [Room No] , RoomAllotment.AcadYear as [Acadeic Year] ,  (FeePayment.ServiceCharges- RegCharges.PrevDue) as [Service Charges] , RegCharges.PrevDue as[Prev Due] ,FeePayment.ServiceCharges as [service Charge+Due],  sum(FeePayment.Totalpaid) as [Total paid] FROM (Hostel INNER JOIN ((Hostelers INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]) INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) ON Hostel.[HostelName] = Hostelers.[HostelName]) INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where   Hostel.HostelType ='" & cmbHostelType1.Text & "' and FeePayment.Paymentdate between #" & DateFrom.Text & " # and #" & DateTo.Text & "# and FeePayment.AcadYear=RoomAllotment.AcadYear and FeePayment.AcadYear=RegCharges.AcadYear and RoomAllotment.AcadYear=RegCharges.AcadYear group by HostelerName,USn,purpose, RoomAllotment.Hostelname,RoomAllotment.RoomNo,ServiceCharges,RoomAllotment.AcadYear,RegCharges.PrevDue,HostelType order by Hostelername ", con)
            Dim myDA As OleDbDataAdapter = New OleDbDataAdapter(cmd)
            Dim myDataSet As DataSet = New DataSet()
            myDA.Fill(myDataSet, "Hostelers")
            myDA.Fill(myDataSet, "FeePayment")
            ...
            For Each r As DataGridViewRow In Me.DataGridView2.Rows
                If (DataGridView2.Rows.Count <= 2) Then
                    If (r.Cells(7).Value > 0) Then
                        ...
                        sum3 = sum3 + ((r.Cells(6).Value + r.Cells(7).Value) - r.Cells(9).Value)
                    Else
                        sum2 = sum2 + r.Cells(9).Value
                        sum3 = sum3 + (r.Cells(6).Value - r.Cells(9).Value)
                    End If
                Else
                    sum2 = sum2 + r.Cells(9).Value
                    sum3 = sum3 + (r.Cells(6).Value - r.Cells(9).Value)
    ...
    Private Sub Button15_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button15.Click
        ...
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            'cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler name],Hostelers.USN as [USN],Hostelers.Purpose as [Department], Hostelers.HostelName as [Hostel Name], FeePayment.AcadYear as [Academic year], FeePayment.TotalPaid as [Total Paid],FeePayment.BankChallanNumber as [Bank Challan No], FeePayment.PaymentDate as [Payment Date] FROM Hostelers INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] ", con)
            'cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler name],Hostelers.USN as [USN],Hostelers.Purpose as [Department], Hostelers.HostelName as [Hostel Name], FeePayment.AcadYear as [Academic year], sum(FeePayment.TotalPaid) as [Total Paid] FROM Hostelers INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] group by HostelerName,USN,Purpose,HostelName,AcadYear order  by HostelerName ", con)
            'cmd = New OleDbCommand("SELECT distinct Hostelers.HostelerName as [Hosteler Name], Hostelers.USN as [USN], Hostelers.Purpose as [Department], RoomAllotment.Hostelname as [Hostel Name], RoomAllotment.RoomNo as [Room No] , RoomAllotment.AcadYear as [Acadeic Year], (FeePayment.ServiceCharges-RegCharges.PrevDue) as [Service Charges], RegCharges.PrevDue as[Prev Due],  FeePayment.ServiceCharges as [service Charge+Due], sum(FeePayment.Totalpaid) as [Total paid] FROM ((Hostelers INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]) INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where    RoomAllotment.AcadYear='" & cmbAcadYear1.Text & "' and FeePayment.AcadYear=RoomAllotment.AcadYear and FeePayment.AcadYear=RegCharges.AcadYear and RoomAllotment.AcadYear=RegCharges.AcadYear group by HostelerName,USn,purpose, RoomAllotment.Hostelname,RoomAllotment.RoomNo,ServiceCharges,RoomAllotment.AcadYear,RegCharges.PrevDue  order by Hostelername ", con)
            cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler Name] , Hostelers.USN as [USN] , RoomAllotment.Hostelname, Hostel.HostelType as [Hostel Name] , RoomAllotment.RoomNo  as [Room No] , RoomAllotment.AcadYear as [Acadeic Year] ,  (FeePayment.ServiceCharges- RegCharges.PrevDue) as [Service Charges] , RegCharges.PrevDue as[Prev Due] ,FeePayment.ServiceCharges as [service Charge+Due],  sum(FeePayment.Totalpaid) as [Total paid] FROM (Hostel INNER JOIN ((Hostelers INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]) INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) ON Hostel.[HostelName] = Hostelers.[HostelName]) INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where   RoomAllotment.AcadYear = '" & cmbAcadYear1.Text & "'  and FeePayment.AcadYear=RoomAllotment.AcadYear and FeePayment.AcadYear=RegCharges.AcadYear and RoomAllotment.AcadYear=RegCharges.AcadYear group by HostelerName,USn,purpose, RoomAllotment.Hostelname,RoomAllotment.RoomNo,ServiceCharges,RoomAllotment.AcadYear,RegCharges.PrevDue,HostelType order by Hostelername ", con)
    ...
    Private Sub Button27_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button27.Click
        ...
        Try
            ...
            'cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler name],Hostelers.USN as [USN],Hostelers.Purpose as [Department], Hostelers.HostelName as [Hostel Name], FeePayment.AcadYear as [Academic year], FeePayment.TotalPaid as [Total Paid],FeePayment.BankChallanNumber as [Bank Challan No], FeePayment.PaymentDate as [Payment Date] FROM Hostelers INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID]  where HostelName='" & cmbHostelName1.Text & "' and AcadYear = '" & cmbAcadYear.Text & "' order by HostelerName,AcadYear,paymentdate", con)
            'cmd = New OleDbCommand("SELECT distinct Hostelers.HostelerName as [Hosteler Name], Hostelers.USN as [USN], Hostelers.Purpose as [Department], RoomAllotment.Hostelname as [Hostel Name], RoomAllotment.RoomNo as [Room No] , RoomAllotment.AcadYear as [Acadeic Year], (FeePayment.ServiceCharges-RegCharges.PrevDue) as [ServiceCharges], RegCharges.PrevDue as[Prev Due],  FeePayment.ServiceCharges as [service Charge+Due], sum(FeePayment.Totalpaid) as [Total paid] FROM ((Hostelers INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]) INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where  RoomAllotment.HostelName BETWEEN RoomAllotment.HostelName='" & cmbHostelName1.Text & "' and RoomAllotment.HostelName='" & cmbHostelName3.Text & "' and RoomAllotment.AcadYear = '" & cmbAcadYear.Text & "' and FeePayment.AcadYear=RoomAllotment.AcadYear and FeePayment.AcadYear=RegCharges.AcadYear and RoomAllotment.AcadYear=RegCharges.AcadYear group by HostelerName,USn,purpose, RoomAllotment.Hostelname,RoomAllotment.RoomNo,ServiceCharges,RoomAllotment.AcadYear,RegCharges.PrevDue  order by Hostelername ", con)
            cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler Name] , Hostelers.USN as [USN] , RoomAllotment.Hostelname as [Hostel Name], Hostel.HostelType as [Hostel Type] , RoomAllotment.RoomNo  as [Room No] , RoomAllotment.AcadYear as [Academic Year] ,  (FeePayment.ServiceCharges- RegCharges.PrevDue) as [Service Charges] , RegCharges.PrevDue as[Prev Due] ,FeePayment.ServiceCharges as [service Charge+Due],  sum(FeePayment.Totalpaid) as [Total paid] FROM (Hostel INNER JOIN ((Hostelers INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]) INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) ON Hostel.[HostelName] = Hostelers.[HostelName]) INNER JOIN FeePayment ON Hostelers.[HostelerID] = FeePayment.[HostelerID] where   RoomAllotment.HostelName ='" & cmbHostelName.Text & "'and RoomAllotment.RoomNo between '" & cmbRoomNo1.Text & "' and '" & cmbRoomNo2.Text & "' and RoomAllotment.AcadYear = '" & cmbAcadYear2.Text & "' and FeePayment.AcadYear=RoomAllotment.AcadYear and FeePayment.AcadYear=RegCharges.AcadYear and RoomAllotment.AcadYear=RegCharges.AcadYear group by HostelerName,USn,purpose, RoomAllotment.Hostelname,RoomAllotment.RoomNo,ServiceCharges,RoomAllotment.AcadYear,RegCharges.PrevDue,HostelType order by Hostelername ", con)
            Dim myDA As OleDbDataAdapter = New OleDbDataAdapter(cmd)
            Dim myDataSet As DataSet = New DataSet()
            myDA.Fill(myDataSet, "Hostelers")
            myDA.Fill(myDataSet, "FeePayment")
            ...
            con.Open()
            'cmd = New OleDbCommand("SELECT Hostelers.HostelerName as [Hosteler Name], Hostelers.USN as [USN],Concession.AcadYear as [Acadeic Year], Concession.Con_Amount as [Concession Amount] FROM Hostelers INNER JOIN Concession ON Hostelers.[HostelerID] = Concession.[HostelerID] ", con)
            cmd = New OleDbCommand(" SELECT Hostelers.HostelerName as [Hosteler Name], Hostelers.USN as [USN], RoomAllotment.Hostelname as [Hostel Name] ,RoomAllotment.RoomNo as [Room No], Hostel.HostelType as [Hostel Type], Concession.AcadYear as [Acad Year], Concession.Con_Amount as [Concession Amt], Concession.Con_Date as [Concession Date] FROM (Hostel INNER JOIN (Hostelers INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) ON Hostel.[HostelName] = Hostelers.[HostelName]) INNER JOIN Concession ON Hostelers.[HostelerID] = Concession.[HostelerID] where RoomAllotment.HostelName ='" & cmbHostelName.Text & "'and RoomAllotment.RoomNo between '" & cmbRoomNo1.Text & "' and '" & cmbRoomNo2.Text & "' and Concession.AcadYear = '" & cmbAcadYear2.Text & "' and Hostelers.AcadYear=RoomAllotment.AcadYear ", con)
            Dim myDA1 As OleDbDataAdapter = New OleDbDataAdapter(cmd)
            Dim myDataSet1 As DataSet = New DataSet()
            myDA1.Fill(myDataSet1, "Hostelers")
            myDA1.Fill(myDataSet1, "Hostel")
