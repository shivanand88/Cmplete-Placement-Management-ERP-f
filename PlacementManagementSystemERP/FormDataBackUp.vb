...
Public Class FormDataBackUp
    ...
    Private Sub FormDataBackUp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Set the two button as disabled
        btnbackup.Enabled = False
        btnrestore.Enabled = False
    End Sub
    Private Sub FormDataBackUp_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Me.Hide()
        FormMain.Show()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnbackup.Click
        ...
        Try
            ...
            If SFD.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                'Reload the form
                Call FormDataBackUp_Load(sender, e)
