...
Public Class frmRefundRecord
    ...
    Private Sub btnGetData_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT Hostelers.HostelerID as  [Hosteler ID], Hostelers.HostelerName as  [Hosteler Name],Hostelers.USN as  [USN],Refund.RefundableAmt as [Refundable Amount],Refund.RefundAmt as [Refund Amount],Refund.ChequeNo as [Checque No],Refund.RefundDate as [Refund Date], Refund.Remarks as [Remarks] from Hostelers,Refund where Hostelers.HostelerID=Refund.HostelerID and Hostelers.HostelerID like '" & txtHosteler.Text & "%' order by HostelerName", con)
