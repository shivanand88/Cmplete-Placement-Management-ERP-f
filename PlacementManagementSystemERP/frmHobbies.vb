...
Public Class frmHobbies
    ...
    Private Sub txtHosteler_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles txtHosteler.MouseUp
        Try
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb As String = "insert into Hobbies(HostelerId,Hobby1,Hobby2,Hobby3,Hobby4,Hobby5,Hobby6,Hobby7,Hobby8) VALUES ('" & cmbHostelerID.Text & "','" & txtHobby1.Text & "','" & txtHobby2.Text & "','" & txtHobby3.Text & "','" & txtHobby4.Text & "','" & txtHobby5.Text & "','" & txtHobby6.Text & "','" & txtHobby7.Text & "','" & txtHobby8.Text & "')"
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb As String = "update Hobbies  set Hobby1='" & txtHobby1.Text & "',Hobby2='" & txtHobby2.Text & "',Hobby3='" & txtHobby3.Text & "',Hobby4='" & txtHobby4.Text & "',Hobby5='" & txtHobby5.Text & "',Hobby6='" & txtHobby6.Text & "',Hobby7='" & txtHobby7.Text & "',Hobby8='" & txtHobby8.Text & "' where  HostelerID='" & cmbHostelerID.Text & "'"
            cmd = New OleDbCommand(cb)
            cmd.Connection = con
            cmd.ExecuteNonQuery()
